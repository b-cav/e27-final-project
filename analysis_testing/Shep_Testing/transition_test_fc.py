...
## JUST A TEST FILE:
# Run MBE_transition_test with or without the part of the init method that reduces the transitions. MBE transitino test will tell
# you the mean number of multi bit errors over 100 trials when run
import heapq 
...
def huffman_init(training_file) :
    ...
    # return(bigram_codebook, bigram_list, bigram_tree)
